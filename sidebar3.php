            ...
            <div class="menu_section">
                <ul class="nav side-menu">
                    <li class="<?php if(isset($active2)){echo $active2;}?>">
                        <a href="tickets3.php"><i class="fa fa-ticket"></i> Tickets</a>
                    </li>

                    <li class="<?php if(isset($active4)){echo $active4;}?>">
                        <a href="requirements3.php"><i class="fa fa-align-left"></i> Requerimientos</a>
                    </li>

                    <li class="<?php if(isset($active3)){echo $active3;}?>">
                        <a href="projects3.php"><i class="fa fa-list-alt"></i> Proyectos</a>
                    </li>

                    <li class="<?php if(isset($active8)){echo $active8;}?>">
                        <a href="tracing3.php"><i class="fa fa-child"></i> Seguimiento</a>
                    </li>
